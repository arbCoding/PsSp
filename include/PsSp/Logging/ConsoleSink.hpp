...
#ifndef PSSP_CONSOLESINK_HPP_20231214_0805
#define PSSP_CONSOLESINK_HPP_20231214_0805
#pragma once
...
/*!
  ...
  \todo At present it doesn't do log formatting (formatting is handled with
  console codes in the logs themselves). Formatting should be moved to here in
  the future for generality.
...
public:
  /*!
    ...
    */
  explicit ConsoleSink(Fl_Terminal *tty) { tty_ = tty; }

protected:
  /*!
    \brief Receives message from spdlog and then passes message to display
    console.
