...
namespace pssp
{
    ...
    // Left-pad integers
    //--------------------------------------------------------------------
    std::string Project::left_pad_integers(int n, int width)
    {
    ...
    // Days per month
    //--------------------------------------------------------------------
    int Project::days_per_month(int year, int month)
    {
    ...
    // YMD to Day of Year
    //--------------------------------------------------------------------
    int Project::ymd_2_doy(int year, int month, int day)
    {
        int doy{0};
    ...
    //--------------------------------------------------------------------
    std::string Project::doy_2_ymd(int year, int doy)
    {
        int month{0};
        int days{0};
    ...
    // Make datetime
    //--------------------------------------------------------------------
    std::string Project::sac_reference_time(SAC::SacStream& sac)
    {
        std::ostringstream oss{};
    ...
    //--------------------------------------------------------------------
    void Project::timestamp_to_reference_headers(const char* raw_timestamp, SAC::SacStream& sac)
    {
