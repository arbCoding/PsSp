...
\urlstyle{same}
% Place thin boxes around figures
%\floatstyle{boxed} 
%\restylefloat{figure}
...
\begin{center}
    \begin{figure}[ht]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption[Wave-packet]{Wave-packet (black) and its corresponding envelope function (blue).}
    \end{figure}
\end{center}
Test figure reference for figure \ref{figure:1}.
