...
% Can add a list of terms and acronyms to the document
...
in \cref{Schematic Time Series}? Yes, in fact it contains a range of frequencies---an observation that is not immediately obvious when written as a function of time.
