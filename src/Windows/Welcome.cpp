...
Welcome_Window::Welcome_Window() : Fl_Window(0, 0, 0, 0, "Welcome!") {
  ...
  set_modal();
  message = std::make_unique<Fl_Box>((welcome::width - welcome::text_width) / 2,
                                     0, welcome::text_width,
                                     welcome::text_height);
  continue_button = std::make_unique<Fl_Return_Button>(
      (welcome::width - welcome::button_width) / 2,
      welcome::text_height, welcome::button_width,
      welcome::button_height, "Continue");
