...
#+title: Passive-source Seismic-processing
...
#+description:
#+keywords:
#+subtitle: C++20 Graphical Seismic Processing Software @@latex:\\@@ @@html:<br>@@ V0.2.0 @@latex:\\@@ @@html:<br>@@ User Manual
...
\begin{titlepage}
    \centering
    \vspace*{2.25in}
    {\Huge \textsc{\textbf{Passive-source Seismic-Processing (PsSp)}}}\\
    \vspace{2\baselineskip}
    {\Large C++20 Graphical Seismic Processing Software}\\
